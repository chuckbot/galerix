...
class DetailScreen extends StatelessWidget {
  const DetailScreen({super.key, required this.initialPage});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Consumer<GalerixProvider>(builder: (_, aluxionProvider, __) {
        return CarouselSlider(
          ...
          items: aluxionProvider.images.map((image) {
            return Builder(
